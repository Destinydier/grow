...
public class GcHotel {
    ...
    private String pmsBrand;

    private String resrvSync;

    private String resrvSyncType;
    ...
    public String getPmsBrand() {
        return pmsBrand;
    }

    public void setPmsBrand(String pmsBrand) {
        this.pmsBrand = pmsBrand;
    }

    public String getResrvSync() {
        return resrvSync;
    }

    public void setResrvSync(String resrvSync) {
        this.resrvSync = resrvSync;
    }

    public String getResrvSyncType() {
        return resrvSyncType;
    }

    public void setResrvSyncType(String resrvSyncType) {
        this.resrvSyncType = resrvSyncType;
    }
